...
class AnimatedCalorieList2 extends StatefulWidget {
  @override
  _AnimatedCalorieList2State createState() =>
      _AnimatedCalorieList2State();
}

class _AnimatedCalorieList2State extends State<AnimatedCalorieList2> {
